import svgPaths from "./svg-w660cfc9jp";
import imgLogo from "./b34d701fd1ceed4106f0f96c9254084af23d9951.png";

function NextIcon() {
  return (
    <div className="absolute left-[712px] size-[16px] top-[948px]" data-name="NEXT ICON">
  ...
  return (
    <div className="absolute flex items-center justify-center left-[1066px] size-[16px] top-[948px]">
      <div className="flex-none rotate-180">
        <div className="relative size-[16px]" data-name="NEXT ICON">
          <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 16 16" width="16">
            <g id="NEXT ICON">
              <path d={svgPaths.pa4fed80} fill="white" fillOpacity="0.88" id="Vector" />
            </g>
...
function ChapterPanel() {
  return (
    <div className="absolute contents left-[691px] top-[914px]" data-name="CHAPTER PANEL">
      <div className="absolute bg-[#141414] h-[83px] left-[691px] rounded-[15px] top-[914px] w-[408px]" data-name="NUMBER PANEL" />
      <NextIcon />
      <NextIcon1 />
      ...
      <div className="absolute bg-[#ca498c] h-[57px] left-[760px] rounded-[10px] top-[927px] w-[42px]" data-name="ACTIVE NUMBER PAGE" />
...
function Status() {
  return (
    <div className="absolute contents left-[1291px] top-[351px]" data-name="STATUS">
      <div className="absolute bg-[rgba(144,238,144,0.2)] h-[29px] left-[1292px] rounded-[10px] top-[351px] w-[68px]" />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[1326px] text-[#b5b47e] text-[20px] text-center top-[354px] w-[70px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        Paid
      </p>
    </div>
  );
...
function ExampleRowTableData() {
  return (
    <div className="absolute contents left-[379px] top-[330px]" data-name="EXAMPLE ROW TABLE DATA">
      <div className="absolute bg-[#141414] border border-[rgba(255,255,255,0.25)] border-solid h-[72px] left-[379px] top-[330px] w-[1032px]" data-name="EXAMPLE ROW TABLE DATA" />
      <Status />
      <p className="[word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[1154px] opacity-75 text-[18px] text-white top-[354px] w-[123px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        22 May 2024
      </p>
      <p className="[word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[1043px] opacity-75 text-[20px] text-white top-[354px] w-[92px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        Gcash
      </p>
      <p className="[word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[932px] opacity-75 text-[20px] text-white top-[354px] w-[92px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        ₱650
      </p>
      <p className="[word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[729px] opacity-75 text-[20px] text-white top-[354px] w-[184px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        Sunflower Bouquet
      </p>
      <p className="[word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[556px] opacity-75 text-[20px] text-white top-[354px] w-[129px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        Maria Santos
      </p>
      <p className="[word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[404px] opacity-75 text-[20px] text-white top-[354px] w-[92px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        #YC-1025
      </p>
    </div>
  );
...
function DropdownIcon() {
  return (
    <div className="absolute left-[1061px] size-[16px] top-[205px]" data-name="DROPDOWN ICON">
      <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 16 16" width="16">
        <g id="DROPDOWN ICON">
...
function AllPaymentDropdown() {
  return (
    <div className="absolute contents left-[895px] top-[177px]" data-name="ALL PAYMENT DROPDOWN">
      <div className="absolute bg-[#141414] border border-[rgba(255,255,255,0.25)] border-solid h-[72px] left-[895px] rounded-[15px] top-[177px] w-[221px]" data-name="ALL PAYMENT DROPDOWN" />
      <p className="[word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[935px] text-[20px] text-[rgba(255,255,255,0.74)] top-[201px] w-[112px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        All Payment
      </p>
      <DropdownIcon />
    </div>
...
function LogoutButton() {
  return (
    <div className="absolute contents left-[16px] top-[906px]" data-name="LOGOUT BUTTON">
      <div className="absolute bg-[rgba(56,28,42,0)] h-[72px] left-[16px] rounded-[10px] top-[906px] w-[328px]" data-name="LOGOUTBUTTON" />
...
function OrderListButton() {
  return (
    <div className="absolute contents left-[16px] top-[396px]" data-name="ORDER LIST BUTTON">
      <div className="absolute bg-[#381c2a] h-[72px] left-[16px] rounded-[10px] top-[396px] w-[328px]" data-name="ORDER BUTTON" />
...
function InventoryButton() {
  return (
    <a className="absolute contents cursor-pointer left-[16px] top-[324px]" data-name="INVENTORY BUTTON">
...
function AddEditButton() {
  return (
    <a className="absolute contents cursor-pointer left-[16px] top-[252px]" data-name="ADD/EDIT BUTTON">
...
function HomePageButton() {
  return (
    <a className="absolute contents cursor-pointer left-[16px] top-[180px]" data-name="HOME PAGE BUTTON">
...
export default function OrderListPage() {
  return (
    <div className="bg-[#0c0d0c] relative size-full" data-name="ORDER LIST PAGE">
      <ChapterPanel />
      ...
      <p className="[word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[1292px] opacity-75 text-[20px] text-[rgba(255,255,255,0.74)] top-[289px] w-[92px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        Status
      </p>
      <p className="[word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[1154px] opacity-75 text-[20px] text-[rgba(255,255,255,0.74)] top-[289px] w-[92px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        Date
      </p>
      <p className="[word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[1043px] opacity-75 text-[20px] text-[rgba(255,255,255,0.74)] top-[289px] w-[92px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        Payment
      </p>
      <p className="[word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[932px] opacity-75 text-[20px] text-[rgba(255,255,255,0.74)] top-[289px] w-[92px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        Price
      </p>
      <p className="[word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[729px] opacity-75 text-[20px] text-[rgba(255,255,255,0.74)] top-[289px] w-[92px]" style={{ fontVariationSettings: '"wdth" 100' }}>{`Category `}</p>
      <p className="[word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[556px] opacity-75 text-[20px] text-[rgba(255,255,255,0.74)] top-[289px] w-[92px]" style={{ fontVariationSettings: '"wdth" 100' }}>{`Customer `}</p>
      <p className="[word-break:break-word] absolute font-['Roboto:Medium',sans-serif] font-medium h-[23px] leading-[normal] left-[404px] opacity-75 text-[20px] text-[rgba(255,255,255,0.74)] top-[289px] w-[92px]" style={{ fontVariationSettings: '"wdth" 100' }}>{`Order ID `}</p>
      <ExampleRowTableData />
      <AllPaymentDropdown />
      <SearchBar />
      ...
      <p className="[word-break:break-word] absolute font-['Crimson_Text:SemiBold',sans-serif] leading-[normal] left-[390px] not-italic text-[64px] text-white top-[45px] whitespace-nowrap">Order List</p>
