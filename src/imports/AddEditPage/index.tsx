import svgPaths from "./svg-pv84xzy2dh";
...
function HomePageButton() {
  return (
    <a className="absolute contents cursor-pointer left-[16px] top-[183px]" data-name="HOME PAGE BUTTON">
...
function AllStatusDropDown() {
  return (
    <button className="absolute contents cursor-pointer left-[889px] top-[177px]" data-name="ALL STATUS DROP DOWN">
