import svgPaths from "./svg-otfo69sob2";
...
function CancelButton() {
  return (
    <a className="absolute contents cursor-pointer left-[1006px] top-[70px]" data-name="CANCEL BUTTON">
...
function OrderButton() {
  return (
    <a className="absolute contents cursor-pointer left-[16px] top-[396px]" data-name="ORDER BUTTON">
...
function DeleteButton1() {
  return (
    <a className="absolute contents cursor-pointer left-[1186px] top-[206px]" data-name="DELETE BUTTON">
